...
- `SKILL.md`  
  The **default balanced** FOAM skill package for Hermes.

- `variants/extreme.md`  
  A **stronger** ready-to-use FOAM variant for Hermes (extreme cut).
...
Both the default and extreme variants are Hermes-packaged adaptations of the canonical OpenClaw/CaiaClaw FOAM v5 master skill body, with Hermes cut parameters applied.

- Canonical master FOAM body: `refs/openclaw-foam/skill_openclaw_v5.md`
- Hermes balanced parameters: `refs/openclaw-foam/hermes_BALANCED_NEW.md`
- Hermes extreme parameters: `refs/openclaw-foam/hermes_EXTREME_NEW.md`
...
`variants/extreme.md` contains the stronger FOAM cut:
- unafraid
- more swarm
- visit the hole

Use this when you explicitly want higher contact pressure + swarm sensitivity + onset intensity than the balanced default.
